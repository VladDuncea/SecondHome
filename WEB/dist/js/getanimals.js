        ...
        if (status == 1) {
            ...
            for (var i = 0; i < nr_animals; i++) {
                ...
                if (request_type_active == 0) {
                    ...
                    // console.log(`${buttonState2}`)
                    // console.log("-----------------------")
                } else if (request_type_active == 2) {

                    const animal_box = card + `
                <div class="card-body" style="padding: 2">   
                <p class="lead" ><b>Utilizator: </b> <a href='#' >${animals[i].first_name} ${animals[i].last_name} </a></p>       
                    <div class="text-center">
                    <button type="button" class="btn btn-secondary" id='${animals[i].PID}acazare' ><i class="fas fa-paw"id='detalii'></i> Accepta</button>    
                    <button type="button" class="btn btn-secondary" id='${animals[i].PID}rcazare' ><i class="fas fa-paw"id='detalii'></i> Refuza</button> 
                    </div> 
                </div>
                </div>
             </div>`;
