...
<body class="hold-transition sidebar-mini" onload="get_animal(0,1);">
    <!-- Site wrapper -->
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="nav-icon fas fa-cat"></i> Pisici</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Acasă</a></li>
                                <li class="breadcrumb-item active"><i class="nav-icon fas fa-cat"></i> Pisici</li>
                            </ol>
                        </div>
                    </div>
                </div>
