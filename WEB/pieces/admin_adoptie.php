...
<body class="hold-transition sidebar-mini" onload="get_animal(2,0);">
    <!-- Site wrapper -->
    <div class="wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>
                            <i class="nav-icon fas fa-paw"></i> Cereri pentru dare spre adoptie
                            </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Acasă</a></li>
                                <li class="breadcrumb-item active"><i class="nav-icon fas fa-paw"></i> Cereri pentru dare spre adoptie</li>
                            </ol>
                        </div>
                    </div>
                </div>
